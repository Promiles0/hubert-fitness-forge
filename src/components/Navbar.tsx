      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/schedule" className="text-white hover:text-fitness-red transition-colors">Schedule</Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-fitness-black/95 absolute top-full left-0 w-full py-4 animate-fade-in">
          <div className="container mx-auto px-4 flex flex-col space-y-4">
            <Link to="/" className="text-white hover:text-fitness-red transition-colors py-2">Home</Link>
            <Link to="/about" className="text-white hover:text-fitness-red transition-colors py-2">About</Link>
            <Link to="/programs" className="text-white hover:text-fitness-red transition-colors py-2">Programs</Link>
            <Link to="/membership" className="text-white hover:text-fitness-red transition-colors py-2">Membership</Link>
            <Link to="/trainers" className="text-white hover:text-fitness-red transition-colors py-2">Trainers</Link>
            <Link to="/schedule" className="text-white hover:text-fitness-red transition-colors py-2">Schedule</Link>
            <Link to="/contact" className="text-white hover:text-fitness-red transition-colors py-2">Contact</Link>
            ...
            {isAuthenticated ? (
              <div className="pt-2 border-t border-gray-700">
                ...
                <Button 
                  variant="outline" 
                  className="w-full justify-start text-white border-white hover:text-fitness-red hover:border-fitness-red mb-3"
