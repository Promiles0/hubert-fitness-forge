...
import { Clock, Users, MapPin, Star, Zap, Heart, AlertCircle } from "lucide-react";
...
const ClassCard = ({ schedule, isBooking, onReserveSpot, isFullyBooked = false, availableSpots = 0 }: ClassCardProps) => {
  ...
  return (
    <Card className={`group relative bg-gradient-to-br from-gray-900/90 via-gray-800/50 to-gray-900/90 border-0 hover:shadow-2xl transition-all duration-700 hover:-translate-y-2 overflow-hidden backdrop-blur-xl ${isFullyBooked ? 'opacity-75' : ''}`}>
      ...
      <div className="relative z-10">
        ...
        <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="flex items-center gap-4 text-gray-300 group-hover:text-white transition-colors duration-300">
                  ...
                  <div className="flex-1">
                    ...
                    <div className={`text-xs font-medium ${isFullyBooked ? 'text-red-400' : 'text-green-400'}`}>
          ...
          {/* Enhanced CTA Button */}
          <Button 
            className={`w-full font-bold py-4 text-lg rounded-xl transition-all duration-500 hover:shadow-2xl group-hover:scale-[1.02] border-0 relative overflow-hidden disabled:opacity-75 disabled:cursor-not-allowed ${
              isFullyBooked 
                ? 'bg-gray-600 hover:bg-gray-700 text-gray-300 cursor-not-allowed' 
                : 'bg-gradient-to-r from-fitness-red to-red-600 hover:from-red-600 hover:to-red-700 text-white hover:shadow-red-500/30'
            }`}
